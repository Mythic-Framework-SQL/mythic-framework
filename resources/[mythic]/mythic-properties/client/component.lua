    ...
    isBackdoor and "Property Backdoor" or "Property", isBackdoor and "house-window" or "house", function(data)
      local pMenu = {
        ...
        },
        {
          ...
          action = function()
            Notification:Error('This Property Has Been Foreclosed! This is why you should pay your property loans...',
              10000)
          end,
          shouldShow = function()
            if not _propertiesLoaded then
...
PROPERTIES = {
  ...
  Furniture = {
    ...
    Place = function(self, model, category, metadata, blockBrowse, skipPhone)
      ...
      ObjectPlacer:Start(GetHashKey(model), "Furniture:Client:Place", metadata, true, "Furniture:Client:Cancel", true,
        fData.placeGround)
