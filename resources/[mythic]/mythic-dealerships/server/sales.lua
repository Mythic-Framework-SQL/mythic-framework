                          ...
                          Vehicles.Owned:AddToCharacter(targetCharacter:GetData('SID'),
                            GetHashKey(saleVehicleData.vehicle), 0, {
                              ...
                              if success and vehicleData then
                                ...
                                Execute:Client(source, 'Notification', 'Error', 'Error Completing Vehicle Sale', 5000,
                                  'car-building')
                                Execute:Client(targetSrc, 'Notification', 'Error', 'Error Completing Vehicle Sale', 5000,
                                  'car-building')
                              end
                              ...
                              Billing:Create(
                                ...
                                function(wasPayed, withAccount)
                                  if wasPayed then
                                    ...
                                    Execute:Client(source, 'Notification', 'Error', 'Loan Downpayment Failed', 5000,
                                      'car-building')
                                  end
                                end
                              )
