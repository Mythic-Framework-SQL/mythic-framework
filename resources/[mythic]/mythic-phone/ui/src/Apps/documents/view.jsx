...
export default (props) => {
	...
	const onSignature = async (e) => {
		...
		try {
			let res = await (
				await Nui.send('SignDocument', document._id)
			).json();
			if (res) {
	...
	return (
		<>
			...
			{sharing != null && (
				...
				>
					<div>
						Sharing without making a copy will allow the recipient
						to see any changes you make to the document!
						<Select
							id="targetType"
							name="targetType"
