		...
		<div {...rest} style={{ display: 'inline-flex' }}>
			...
			>
				<List>
					...
					<ListItem>
						<ListItemText primary="Issued" secondary={<Moment date={strike.Date} format="LLL" />} />
					</ListItem>
					<ListItem>
						<ListItemText
							primary="Issued By"
							secondary={
								<Link className={classes.link} to={`/roster?id=${strike.Author.SID}`}>
									{formatPerson(
										strike.Author.First,
										strike.Author.Last,
										strike.Author.Callsign,
										strike.Author.SID,
									)}
								</Link>
							}
